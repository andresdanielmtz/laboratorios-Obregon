    ...
    <div className="QueSomos">
      ...
      <div id="QueSomos-content">
        ...
        <p>
          ...
          nuestros clientes. Nuestro compromiso es ofrecer diagnósticos precisos
          y confiables, respaldados por un equipo de profesionales altamente
          capacitados y tecnología de vanguardia.{" "}
        </p>
        ...
        <div id="services-list">
          ...
          <ul>
            ...
            <li> Servicios a empresas y público en general. </li>
            <li> Servicios a instituciones gubernamentales (ISSTE). </li>
          </ul>
        </div>
      </div>
    </div>
